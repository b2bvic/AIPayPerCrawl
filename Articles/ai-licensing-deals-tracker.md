---
title:: AI Licensing Deals Tracker: Comprehensive Database of Publisher-to-AI Training Data Agreements (OpenAI, Anthropic, Google)
description:: Track all confirmed AI content licensing deals—pricing, terms, publishers involved—to benchmark negotiations and identify market trends.
...
**Anthropic** discloses fewer deals publicly but emphasizes quality and [attribution-focused licensing strategy](anthropic-publisher-licensing-strategy.html).
...
Different content categories command different licensing rates (inferred from disclosed deals and [industry rate cards](ai-licensing-rate-cards-industry.html)).
...
Contracts include attribution requirements, but effectiveness varies. **OpenAI** and **Anthropic** implement in-line citations; **Google** resists. Even with attribution, [AI search traffic redistribution](ai-search-traffic-redistribution.html) means clicks often stay with AI interface rather than visiting publisher sites.
...
**Implication:** Small publishers should explore [collective licensing coalitions](ai-data-marketplace-publishers.html) rather than solo deals.
...
**Implication:** Documenting [robots.txt violations](ai-crawlers-ignore-robots-txt.html) and copyright concerns strengthens negotiating position.
...
**SEC Filings:**
Public companies (News Corp, Reddit, Thomson Reuters) disclose material contracts in 10-K, 10-Q, 8-K filings. Search for "AI," "OpenAI," "Anthropic," "Google," "training data," "licensing."

**Press Releases:**
AI companies and publishers announce partnerships via PR departments. Subscribe to:
- OpenAI newsroom
- Anthropic blog
- Google AI blog
...
**Industry Reporting:**
Trade publications cover deals:
- Axios Media Trends
...
**Comparable Deals:**
If The Atlantic (5,000 articles/year) gets $10-15M, and you publish 2,500 articles/year with similar quality, estimate $5-7.5M.

**Per-Article Benchmarks:**
Use [industry rate cards](ai-licensing-rate-cards-industry.html) ($0.10-0.50/article) multiplied by article count.

**Crawler Traffic Analysis:**
If [AI crawler traffic analytics](ai-crawler-traffic-analytics.html) show GPTBot crawling 50,000 pages/month, apply CPM pricing ($2-5 CPM = $100-250/month minimum deal value, scaled up).

**Rumor Verification:**
Cross-reference industry rumors across multiple sources. Single-source claims are speculative; three independent sources confirm patterns.
...
**Example:**
You're a mid-sized tech blog (3,000 articles/year, technical how-to content, 500K monthly visitors). Comparable: Stack Overflow (technical), Dotdash Meredith (practical content), The Verge (tech news).
...
**Example Calculation:**
Stack Overflow deal estimated $10M/year for 50M posts. You have 100K technical posts (0.2% of Stack Overflow's volume). Naive estimate: $10M × 0.002 = $20K/year. But adjust for quality (your posts are curated, theirs include low-quality UGC—add 50%): $30K/year baseline.

### Setting Your Negotiation Range

**Minimum Acceptable Price (MAP):**
Lowest price you'd accept before walking away. Set this at 60-70% of your estimate.

**Target Price:**
Your realistic goal. Set at 100-120% of your estimate (negotiate down from here).

**Aspirational Price:**
Maximum conceivable ask. Set at 150-200% of estimate (anchor high, AI companies negotiate down).
...
Officially disclosed figures (News Corp $250M, Reddit $60M) are accurate—sourced from SEC filings or press releases. Undisclosed deals are estimated using comparable deal benchmarks, per-article pricing models from [industry rate cards](ai-licensing-rate-cards-industry.html), and industry source triangulation. Estimates carry ±30% error bars. Use as directional guidance, not precise benchmarks.
