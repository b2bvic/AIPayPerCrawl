---
title:: AI Search Traffic Redistribution: How LLM Answer Engines Collapse Publisher Economics
description:: AI search engines like Perplexity and Google AI Overviews extract value from publisher content while eliminating traffic—forcing a shift from attention to licensing models.
focus_keyword:: ai search traffic redistribution
...
Risk: AI companies ignore robots.txt or use third-party scraping services. Enforcement requires legal threats or technical measures (IP blocking, rate limiting). See [block-perplexitybot-robots-txt](block-perplexitybot-robots-txt.html) for implementation.
...
See [building-content-ai-licensing-revenue](building-content-ai-licensing-revenue.html) for implementation.
...
See [ai-training-data-copyright](ai-training-data-copyright.html) for legal frameworks.
